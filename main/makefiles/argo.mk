# Makefile
.PHONY: help cluster-up cluster-down bootstrap deploy clean status
...
SEALED_SECRETS_KEY ?= sealed-secrets-dev-20251217-222043.key
ENVIRONMENT ?= dev
...
all: cluster-up bootstrap deploy ## 전체 프로세스 (클러스터 → Bootstrap → 배포)
	@echo ""
	@echo -e "$(GREEN)━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━$(NC)"
